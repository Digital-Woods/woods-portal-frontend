const HeaderCard = ({
    ...
    return (
      <div className={`relative h-36 rounded-lg w-full flex items-center justify-between overflow-hidden ${bgImageClass}`}>
        ...
        <div className="relative flex gap-3 mb-10 px-4 z-10">
          {showFollowing && (
            <span className="flex gap-x-4 bg-white text-gray-400 rounded-md px-4 py-2 font-medium text-sm">
              {following}
              <span>
                <svg
