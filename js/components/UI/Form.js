    ...
    <div className="relative dark:bg-dark-200 flex items-center ">
      ...
      <input
        ...
        className={classNames(
          "w-full rounded-md bg-white pl-10 px-5 py-3 text-sm transition-colors border border-2 dark:border-gray-600 focus:bg-flatGray focus:ring-0 border border-flatGray focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        ref={ref}
        {...props}
